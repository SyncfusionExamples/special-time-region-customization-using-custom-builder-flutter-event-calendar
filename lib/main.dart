...
void main() => runApp(const TimeRegion_Builder());

class TimeRegion_Builder extends StatelessWidget {
  const TimeRegion_Builder({super.key});
...
List<TimeRegion> _getTimeRegions() {
  ...
  regions.add(TimeRegion(
    startTime: DateTime(date.year, date.month, 15, 13, 0, 0),
    endTime: DateTime(date.year, date.month, 15, 14, 0, 0),
  ...
  regions.add(TimeRegion(
    startTime: DateTime(date.year, date.month, 15, 00, 0, 0),
    endTime: DateTime(date.year, date.month, 15, 24, 0, 0),
